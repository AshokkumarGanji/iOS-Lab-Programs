...
class ViewController: UIViewController {
    ...
    // Declare an array  with at least  5 words  and the related hints
    
    var words=[["SWIFT","Programming Language","swift"],["DOG","Animal","dog"],["IPHONE","OS designed in 2008","iphone"],["CAR","vehicle","car"],["DHONI","Cricketer","dhoni"]]
